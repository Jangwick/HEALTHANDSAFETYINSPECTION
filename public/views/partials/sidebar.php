...
<aside class="w-72 bg-white text-slate-600 flex-shrink-0 hidden md:flex flex-col border-r border-slate-200 shadow-sm z-30">
    ...
    <nav class="flex-1 overflow-y-auto py-4">
        <div class="px-4 space-y-1">
            ...
            <a href="/public/dashboard.php" class="<?php echo ($activePage ?? '') == 'dashboard' ? 'bg-blue-50 text-blue-700 border border-blue-100 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'; ?> group flex items-center px-4 py-3 text-xs font-semibold rounded-xl transition-all duration-200">
            ...
            <a href="/public/views/inspections/list.php" class="<?php echo ($activePage ?? '') == 'inspections' ? 'bg-blue-50 text-blue-700 border border-blue-100 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'; ?> group flex items-center px-4 py-3 text-xs font-semibold rounded-xl transition-all duration-200">
            ...
            <a href="/public/views/inspections/scheduling.php" class="<?php echo ($activePage ?? '') == 'scheduling' ? 'bg-blue-50 text-blue-700 border border-blue-100 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'; ?> group flex items-center px-4 py-3 text-xs font-semibold rounded-xl transition-all duration-200">
            ...
            <a href="/public/views/establishments/list.php" class="<?php echo ($activePage ?? '') == 'establishments' ? 'bg-blue-50 text-blue-700 border border-blue-100 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'; ?> group flex items-center px-4 py-3 text-xs font-semibold rounded-xl transition-all duration-200">
            ...
            <a href="/public/views/certificates/list.php" class="<?php echo ($activePage ?? '') == 'certificates' ? 'bg-blue-50 text-blue-700 border border-blue-100 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'; ?> group flex items-center px-4 py-3 text-xs font-semibold rounded-xl transition-all duration-200">
            ...
            <?php if (($_SESSION['role'] ?? '') !== 'establishment_owner'): ?>
            <a href="/public/views/violations/list.php" class="<?php echo ($activePage ?? '') == 'violations' ? 'bg-blue-50 text-blue-700 border border-blue-100 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'; ?> group flex items-center px-4 py-3 text-xs font-semibold rounded-xl transition-all duration-200">
            ...
            <a href="/public/views/inspectors/list.php" class="<?php echo ($activePage ?? '') == 'inspectors' ? 'bg-blue-50 text-blue-700 border border-blue-100 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'; ?> group flex items-center px-4 py-3 text-xs font-semibold rounded-xl transition-all duration-200">
            ...
            <a href="/public/views/integrations/hub.php" class="<?php echo ($activePage ?? '') == 'integrations' ? 'bg-blue-50 text-blue-700 border border-blue-100 shadow-sm' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'; ?> group flex items-center px-4 py-3 text-xs font-semibold rounded-xl transition-all duration-200">
    ...
    <div class="px-4 py-6 bg-white border-t border-slate-100">
        ...
        <a href="/public/views/auth/logout.php" class="flex items-center justify-center gap-3 w-full h-11 text-xs font-bold text-slate-500 hover:text-rose-600 border border-slate-100 rounded-xl transition-all hover:bg-rose-50 hover:border-rose-100">
